...
if 'refArea' in df.columns and 'Nb of Covid-19 cases' in df.columns and 'Existence of chronic diseases - Cardiovascular disease ' in df.columns:
    ...
    coords_data = {
        'Governorate': [
            'Mount_Lebanon_Governorate', 'South_Governorate', 'Akkar_Governorate', 'Baabda_District', 'Byblos_District', 
            'Tyre_District', 'Bsharri_District',  'Batroun_District', 
            'Zgharta_District', 'Keserwan_District',  'Nabatieh_Governorate', 
        ...
        'Latitude': [
            33.737305, 33.340319, 34.555501, 33.844179, 34.123695, 
            33.213081, 34.238451,  34.247192, 34.360090, 34.012735, 
            33.772089, 33.674620, 33.909724, 34.388802, 33.183254, 33.376925, 33.806659,
            33.600089
        ],
        'Longitude': [
            35.599890, 35.303844, 36.201645, 35.703280, 35.649356, 
            35.288796, 35.986991,  35.725521, 35.898134, 35.787238, 
    ...
    # Check lengths of lists in coords_data
